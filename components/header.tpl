    ...
    <section class="header-top">
      ...
      {% if editmode or site.has_many_languages? %}
        <nav class="lang-menu js-menu-lang-wrap {% if flags_state %}flags-enabled{% else %}flags-disabled{% endif %} js-lang-menu">
          <button id="lang-menu-toggle" class="toggle-btn lang-menu-toggle lang-flag lang-flag-{{ page.language_code }} {% if flags_state %}flags-enabled{% else %}flags-disabled{% endif %}" data-lang-code="{{ page.language_code }}" {{ edy_intro_add_lang }}>
